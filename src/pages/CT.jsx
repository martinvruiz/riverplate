...
console.log(data)
    ...
    return <div className="flex flex-col justify-center items-center font-poppins">
        <h2 className="my-8 text-2xl lg:text-5xl font-bold">Cuerpo Tecnico 2023/2024</h2>
        <section className="flex flex-col lg:flex-row flex-wrap items-center justify-center">
            {
                data.map(data=>(
                    <div className="w-3/4 lg:w-1/4 p-3 text-center flex flex-col items-center justify-center mx-6 my-5 border-2 rounded-2xl border-red-600" key={data.name}>
